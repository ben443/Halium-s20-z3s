...
static unsigned int default_efficient_freq_lp[] = {2106000};
static u64 default_up_delay_lp[] = {100 * NSEC_PER_MSEC};

static unsigned int default_efficient_freq_hp[] = {2400000};
static u64 default_up_delay_hp[] = {100 * NSEC_PER_MSEC};

static unsigned int default_efficient_freq_pr[] = {2522000};
